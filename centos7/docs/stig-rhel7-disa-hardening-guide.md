...
### Disk Partitions
CentOS 7 Installer  creates creates separate logical volumes for  ```/, /boot, and swap.``` and you need to creating separate partitions for the following mount points.  For information and understand the rationals behind having seperate partions of please refer t

 - Ensure ```/tmp``` Located On Separate Partition 
 - 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MzY3NDY4MDFdfQ==
-->