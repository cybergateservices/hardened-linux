...
### Disk Partitions
CentOS 7 Installer  creates creates separate logical volumes for  ```/, /boot, and swap.``` and you need to creating separate partitions for the following mount points.  For informationa

 - Ensure ```/tmp``` Located On Separate Partition 
 - 

<!--stackedit_data:
eyJoaXN0b3J5IjpbOTc0NDY3NzY0XX0=
-->