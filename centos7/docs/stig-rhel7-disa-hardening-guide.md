...
It will not be possible and practical to change the partition during a remediation steps on a production systems. If you installing a system which you need to comply with

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg1NzAxMzY4Nl19
-->