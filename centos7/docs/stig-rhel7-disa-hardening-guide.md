...
Click [here](https://static.open-scap.org/ssg-guides/ssg-rhel7-guide-stig-rhel7-disa.html#xccdf_org.ssgproject.content_group_password_storage) to learn more.

 

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNzc5Nzk2ODldfQ==
-->