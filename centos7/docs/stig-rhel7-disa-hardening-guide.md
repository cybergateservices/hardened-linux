...
Using the kickstart file ditectly from  this site you can install CentOS 7 in any virtual, baremetal, or cloud privider that support kickstar
## Updating Software
To meet demands enforced by our security policy we need to keep the software up

<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYxODE3MzRdfQ==
-->