...
During the installation you can choose the relevant security policy so that you can several security requirement automated. In our kickstart file we will call RH


<!--stackedit_data:
eyJoaXN0b3J5IjpbODIyMTMxMzYwXX0=
-->