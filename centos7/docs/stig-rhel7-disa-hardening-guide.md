...
It will not be possible and practical to change the partition during a remediation steps on a production systems. If you installing a system which you need to comply with  this STIG policy we  suggest you to use the [kickstart file](hardened-linux/centos7/ks/stig-centos7-ks.cfg) which we includ


<!--stackedit_data:
eyJoaXN0b3J5IjpbNzAxNjE5Nzg4XX0=
-->