...
It is recommended to visit [DISA STIG profile for Red Hat Enterprise Linux 7](https://static.open-scap.org/ssg-guides/ssg-rhel7-guide-stig-rhel7-disa.html)  to learn more about this profile before you implement it in your production environment.  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMDcxNTcxOTRdfQ==
-->