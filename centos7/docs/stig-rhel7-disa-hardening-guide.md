...
Since this guide do not use the graphical interface we will not discuss it here. Please refer to the [GNOME Desktop Environment]() section of the STI


<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0OTU3NjYzN119
-->